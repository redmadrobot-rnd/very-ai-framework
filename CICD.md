...
| `.github/scripts/gitmark.sh` | резолвер GitMark CLI для `.codex/skills` или `.claude/skills` |
...
| `skills/setup-framework-codex/` | Codex-скилл: развернуть этот фреймворк в другом репозитории |
| `skills/setup-framework/` | Claude-скилл: развернуть этот фреймворк в другом репозитории |

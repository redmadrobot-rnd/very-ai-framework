...
| `.github/overview/` | Overview | overview-сайт: `overview.rules.md` (ТЗ) + `template/` (скелет) + `overview-build.md` (инструкция CI-агенту, **не скилл**). Выходы агента — на orphan-ветке `overview` |

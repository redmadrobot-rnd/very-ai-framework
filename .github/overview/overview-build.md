...
шаблон (`.github/overview/template/`) и детерминированный рендер (`overview_render.py`) собирают HTML сами.
...
- **Входы человека** (на `main`): `.github/overview/overview.rules.md` — ТЗ; `.github/overview/template/` — скелет.
- **Твои выходы**: `.github/overview/{onepager.md, hld.md, changelog.md, architecture/*.puml}`.
...
1. **Прочитай ТЗ.** `.github/overview/overview.rules.md` — что обязательно показать, что скрыть, ссылки,

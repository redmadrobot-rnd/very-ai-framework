...
Команда известна заранее — второй инструмент выполняет её без агента: тот же фильтр и
та же песочница, но дословный вывод, без токенов модели и за секунду.

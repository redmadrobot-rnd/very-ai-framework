...
(админ видит все прогоны и ссылку в админку, инженер только свои). Токен живёт в
`sessionStorage` вкладки, на сервер как cookie не уходит. Чужой прогон инженеру
